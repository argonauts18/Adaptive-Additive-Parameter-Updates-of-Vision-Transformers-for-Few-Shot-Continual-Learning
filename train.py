...
def get_command_line_parser():
    ...
    parser.add_argument('--finetune_lr', type=float, default=0.001, help='Learning rate for the unfrozen encoder layers')
    parser.add_argument('--classifier_lr', type=float, default=0.01, help='Learning rate for the classifier')
